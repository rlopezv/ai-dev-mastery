...
│   ├── SESSION-CONTEXT.md
│   └── reports/                  ← temporary reports from /review-doc, /audit-module, /audit, /enrich (not committed)
├── standards/
│   ├── frontmatter/
│   │   └── frontmatter-spec.md
│   ├── writing/
...
Temporary storage for reports generated by `/review-doc`, `/audit-module`, `/audit`, and `/enrich`.
Review reports are consumed by `/fix-doc`. Audit and enrich reports require human review.
